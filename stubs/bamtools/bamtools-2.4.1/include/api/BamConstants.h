...
// RP: bamtools is a stub in dragmap because all we need is some of the constants below. Including BAM_CIGAR_SHIFT that
// has to be a #define to avoid conflict with ssw.h
...
//RP: this has to be a define or else it will conflict with ssw.h
...
const int8_t   Z_DEFAULT_MEM_LEVEL       = 9;
//--END EDICO EDITED
